...
def helpmessage():
    helpMessage = "╔═══════════════" + "\n" + \
                  "╠  ༎༎ོེཽེོུུུུ࿆༘༘༙࿆Lཽཽ࿆࿆Lཽ࿆Sཽ࿆_࿆Bཽ࿆Oཽ࿆Tཽ࿆༎༎ོེེོུུ࿆༙༘" + "\n" + \
                  "║" + "\n" + \
                  "╠══📨〘 Help 〙📨══" + "\n" + \
                  "║" + "\n" + \
                  "╠📨〘 Help 〙📨════════" + "\n" + \
                  ...
                  "║" + "\n" + \
                  "╚═ ༎༎྄ོེིཻུ༹࿆༘࿆ྂྃLཽཻ࿆Lཽ࿆Sཽ࿆-࿆Bཽ࿆Oཽ࿆Tཽ࿆༎༎ོེཽུ࿆࿆༌ོེུུུ༘༙  "
    return helpMessage
...
def helptexttospeech():
    helpTextToSpeech =   "╔══[ T E X T   T O   S P E E C H ]" + "\n" + \
                         ...
                         "╠ vi : Vietnamese" + "\n" + \
                         "╠ cy : Welsh" + "\n" + \
                         "╚══[ ༎༎༌ེིོཻཽུ࿆༘༘༙Lཽ࿆Lཽ࿆Sཽ࿆-࿆Bཽ࿆Oཽ࿆Tཽ࿆༎༎ོེཽུ࿆༘༙༘ ]" + "\n" + "\n\n" + \
                          "Contoh : say-id Sayang"
...
def helptranslate():
    helpTranslate =    "╔══[ T R A N S L A T E ]" + "\n" + \
                       ...
                       "╠ fil : Filipino" + "\n" + \
                       "╠ he : Hebrew" + "\n" + \
                       "╚══[ ༎༎ོེཽིུ࿆༘༙༘࿆࿆ྂLཽ࿆Lཽ࿆Sཽ࿆-࿆Bཽ࿆Oཽ࿆Tཽ࿆༎༎ོེཽཻུ࿆࿆༙༘༘ྂཾ ]" + "\n" + "\n\n" + \
                         "Contoh : tr-idCantik"
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    nadya.sendContact(to, "uc3ca1071a5202e3e8d5bd6fb32fdeefb")
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "uc3ca1071a5202e3e8d5bd6fb32fdeefb"
                        ...
                        ret_ += "\n╠══[ About Selfbot ]"
                        ret_ += "\n╠ Version : Beta Test"
                        ret_ += "\n╠ Creator : {uc3ca1071a5202e3e8d5bd6fb32fdeefb}".format(creator.displayName)
                        ret_ += "\n╚══[ Dilarang Remake :D ]"
